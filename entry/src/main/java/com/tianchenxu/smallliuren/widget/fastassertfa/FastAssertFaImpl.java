package com.tianchenxu.smallliuren.widget.fastassertfa;
...
public class FastAssertFaImpl extends FormController {
    private static final HiLogLabel TAG = new HiLogLabel(HiLog.DEBUG, 0x0, FastAssertFaImpl.class.getName());
    private static final int DIMENSION_1X2 = 1;
    private static final int DIMENSION_2X4 = 3;

    public FastAssertFaImpl(Context context, String formName, Integer dimension) {
